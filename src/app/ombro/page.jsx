...
export default function Alongamento() {
  ...
  const exercicios = [
    {
      id: 1,
      url: "https://www.youtube.com/watch?v=l5TmadCQqDg",
    },
    {
      id: 2,
      url: "https://www.youtube.com/watch?v=r1HjX2ywkzI",
    },
    {
      id: 3,
      url: "https://www.youtube.com/watch?v=vdcka4X1irc",
    },
    {
      id: 4,
      url: "https://www.youtube.com/watch?v=oRXtT3zZodE",
    },
  ];
  ...
  return (
    <div>
      ...
      <div className="mx-4 mt-3 mb-16 md:mb-0">
        <h1 className=" text-lg font-semibold">Treino de Ombro</h1>
