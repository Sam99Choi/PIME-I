  ...
  return (
    <div className=" flex flex-col scroll-auto w-auto h-screen ">
      ...
      <div className="static  md:mt-5 mx:mt-0 sm:pb-10 flex flex-col items-center justify-center w-auto">
        <div className="  mb-4 /sm:mb-3 w-full px-4 flex flex-col justify-center rounded-md scroll-auto sm:border-2 sm:shadow-lg md:w-8/12 lg:w-6/12 xl:w-4/12  pt-5 pb-5 sm:pb-0 ">
          <h1 className=" w-full 96 /px-4 sm:px-0 text-lg font-bold semibold">Ranking</h1>
