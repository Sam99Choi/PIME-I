...
export default function Alongamento() {
  ...
  const exercicios = [
    {
      id: 1,
      url: "https://www.youtube.com/watch?v=6kEWvyrpH0Y",
    },
    {
      id: 2,
      url: "https://www.youtube.com/watch?v=PBAN_OeKOAc",
    },
    {
      id: 3,
      url: "https://www.youtube.com/watch?v=4n52rSBh3Yk",
    },
    {
      id: 4,
      url: "https://www.youtube.com/watch?v=O9ackGtKUB0",
    },
  ];
  ...
  return (
    <div>
      ...
      <div className="mx-4 mt-3 mb-16 md:mb-0">
        <h1 className=" text-lg font-semibold">Treino de Perna</h1>
